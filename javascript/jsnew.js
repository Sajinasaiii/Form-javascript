...
if(!pass.match(password)||!pass1.match(password))
    {
        ...
        // Notvalid[9].innerHTML="Password which must include one small,capital,special letters";
...
if (file=="") 
    {
        Notvalid[10].innerHTML="Profile image must be filled out";
        // alert("Profile image must be filled out");
        // return false;
    }
else
    {
        Notvalid[10].innerHTML="";
    }
}
